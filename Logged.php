...
<link href="css/stylelogged.css" rel="stylesheet" type="text/css" media="all" />
</head>
<body>
<div class="wrap">
<div class="header">
       <?php
       echo "<p style='color:white;display:inline-block;margin-left:500px'>";
       echo "Welcome Hello";?>
        <div  class="login">
            <form>
            ...
            <form action="">
              <input type="button" onclick="location.href='profilepage.php'" value="View My Profile" />
            </form>
...
<div class="cont-box1">
		 <div class="grid2">
 			<h4><img src="images/h4-bg.png" alt=""><a>Book A Room</a></h4>
...
<div class="cont-grid-list">
	 <h4><img src="images/h4-bg.png" alt=""><a>In <span> Room</span></a></h4>
	 <div class="cont-nav">
	<nav>
	<ul>
...
<div class="cont-grid-list">
	 <h4><img src="images/h4-bg.png" alt=""><a>Soft <span>Deals</span></a></h4>
	 <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when </p>
	 <div class="grid_2">
		<ul class="list">
...
<div class="cont-grid-list">
	 <h4><img src="images/h4-bg.png" alt=""><a>SPECIAL <span>OFFER!</span></a></h4>
	 <div class="cont-img-logo">
